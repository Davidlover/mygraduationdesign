    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_insert_image:
                if (ContextCompat.checkSelfPermission(NewActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) !=
        ...
        switch (requestCode) {
            case 1:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this, "赛马大会", Toast.LENGTH_SHORT).show();
                }
                break;
            default:
