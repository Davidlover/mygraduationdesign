...
import Adapter.MyNoteListAdapter;
import bean.Note;
import db.NoteDao;
...
public class Sent_Strategy_MainActivity extends BaseActivity {
    private static final String TAG = "Sent_Strategy_MainActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sent_strategy);
    ...
    private void initView() {
        ...
        mNoteListAdapter.setOnItemClickListener(new MyNoteListAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, Note note) {
                ...
                Intent intent = new Intent(Sent_Strategy_MainActivity.this, NoteActivity.class);
        ...
        mNoteListAdapter.setOnItemLongClickListener(new MyNoteListAdapter.OnRecyclerViewItemLongClickListener() {
            ...
            public void onItemLongClick(View view, final Note note) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Sent_Strategy_MainActivity.this);
                builder.setTitle("提示");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_new_note:
                Intent intent = new Intent(Sent_Strategy_MainActivity.this, NewActivity.class);
